...
class InvoiceSuitePeppol30InvoiceProviderReader extends InvoiceSuiteAbstractDocumentFormatReader
{
    ...
    public function getDocumentSellerTaxRepresentativeTaxRegistration(
         ...
         * @var array<PartyTaxScheme>
         */
        $documentSellerTaxRepresentativeTaxRegistrations = InvoiceSuiteArrayUtils::ensure($this->getUblRootObject()->getTaxRepresentativeParty()?->getPartyTaxScheme() ?? []);
        ...
        $newTaxRegistrationType = $documentSellerTaxRepresentativeTaxRegistration->getTaxScheme()?->getID()?->getValue() ?? '';
        $newTaxRegistrationId = $documentSellerTaxRepresentativeTaxRegistration->getCompanyID()?->getValue() ?? '';
    ...
    public function getDocumentSellerTaxRepresentativeAddress(
         ...
         * @var array<PostalAddress>
         */
        $documentSellerTaxRepresentativeAddresses = InvoiceSuiteArrayUtils::ensure($this->getUblRootObject()->getTaxRepresentativeParty()?->getPostalAddress() ?? []);
        ...
        $newAddressLine1 = $documentSellerTaxRepresentativeAddress->getStreetName()?->getValue() ?? '';
        $newAddressLine2 = $documentSellerTaxRepresentativeAddress->getAdditionalStreetName()?->getValue() ?? '';
        $newAddressLine3 = $documentSellerTaxRepresentativeAddress->firstAddressLine()?->getLine()?->getValue() ?? '';
        $newPostcode = $documentSellerTaxRepresentativeAddress->getPostalZone()?->getValue() ?? '';
        $newCity = $documentSellerTaxRepresentativeAddress->getCityName()?->getValue() ?? '';
        $newCountryId = $documentSellerTaxRepresentativeAddress->getCountry()?->getIdentificationCode()?->getValue() ?? '';
        $newSubDivision = $documentSellerTaxRepresentativeAddress->getCountrySubentity()?->getValue() ?? '';
