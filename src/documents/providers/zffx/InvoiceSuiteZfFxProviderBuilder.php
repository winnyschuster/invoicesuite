...
class InvoiceSuiteZfFxProviderBuilder extends InvoiceSuiteAbstractDocumentFormatBuilder
{
    ...
    public function createFromDTO(
        ...
        $newDocumentDTO
            ...
            ?->firstName(
                fn (string $item) => $this->setDocumentBuyerTaxRepresentativeName($item)
            )
            ?->firstId(
                fn (InvoiceSuiteIdDTO $item) => $this->setDocumentBuyerTaxRepresentativeId($item->getId())
            )
            ?->forEachGlobalId(
                fn (InvoiceSuiteIdDTO $item) => $this->addDocumentBuyerTaxRepresentativeGlobalId($item->getId(), $item->getIdType())
            )
            ?->firstTaxRegistration(
                fn (InvoiceSuiteIdDTO $item) => $this->setDocumentBuyerTaxRepresentativeTaxRegistration($item->getIdType(), $item->getId())
            )
            ?->firstAddress(
                fn (InvoiceSuiteAddressDTO $item) => $this->setDocumentBuyerTaxRepresentativeAddress(
                    $item->getAddressLine1(),
                    $item->getAddressLine2(),
                    $item->getAddressLine3(),
                    $item->getPostcode(),
            ...
            ?->firstLegalOrganisation(
                fn (InvoiceSuiteOrganisationDTO $item) => $this->setDocumentBuyerTaxRepresentativeLegalOrganisation(
                    $item->getIdType(),
                    $item->getId(),
                    $item->getName()
                )
            ...
            ?->forEachContact(
                fn (InvoiceSuiteContactDTO $item) => $this->addDocumentBuyerTaxRepresentativeContact(
                    $item->getPersonName(),
                    $item->getDepartmentName(),
                    $item->getPhoneNumber(),
                    $item->getFaxNumber(),
    ...
    public function setDocumentBuyerTaxRepresentativeId(
        ...
        $this->addDocumentBuyerTaxRepresentativeId($newId);
    ...
    public function setDocumentBuyerTaxRepresentativeGlobalId(
        ...
        $this->addDocumentBuyerTaxRepresentativeGlobalId($newGlobalId, $newGlobalIdType);
    ...
    public function setDocumentBuyerTaxRepresentativeTaxRegistration(
        ...
        $this->addDocumentBuyerTaxRepresentativeTaxRegistration($newTaxRegistrationType, $newTaxRegistrationId);
    ...
    public function addDocumentBuyerTaxRepresentativeAddress(
        ...
        $this->setDocumentBuyerTaxRepresentativeAddress(
            $newAddressLine1,
            $newAddressLine2,
            $newAddressLine3,
            $newPostcode,
    ...
    public function addDocumentBuyerTaxRepresentativeLegalOrganisation(
        ...
        $this->setDocumentBuyerTaxRepresentativeLegalOrganisation($newType, $newId, $newName);
    ...
    public function setDocumentBuyerTaxRepresentativeContact(
        ...
        $this->addDocumentBuyerTaxRepresentativeContact(
            $newPersonName,
            $newDepartmentName,
            $newPhoneNumber,
            $newFaxNumber,
