...
class ReminderLineType
{
    ...
    /**
     * @var array<\horstoeko\invoicesuite\models\ubl\cac\ReminderPeriod>|null
     * @JMS\Groups({"ubl"})
    ...
    /**
     * @param array<\horstoeko\invoicesuite\models\ubl\cac\ReminderPeriod>|null $reminderPeriod
     * @return self
     */
