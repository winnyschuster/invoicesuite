 ...
 * @return bool
 */
function helpterValidateInvoiceSuiteDocumentBuilder(InvoiceSuiteDocumentBuilder $documentBuilder): bool
{
 ...
 * @return string
 */
function helperVisualizeInvoiceSuiteDocumentBuilder(InvoiceSuiteDocumentBuilder $documentBuilder, string $tofilename = ''): string
{
...
/**
 * Helper for outputting the information read from the electronic invoice document
 *
 * @param  InvoiceSuiteAbstractDocumentFormatReader|InvoiceSuiteDocumentReader $reader
 * @return void
 */
function helperOutputDocumentReader(InvoiceSuiteAbstractDocumentFormatReader|InvoiceSuiteDocumentReader $reader): void
{
    ...
    // Read information about the buyer/customer
    ...
    // Read information about the Ship-To Party
    ...
    // Read information about the ultimate Ship-TO Party
    ...
    // Read information about the Ship-From Party
    ...
    // Read information about the Invoicer Party
    ...
    // Read information about the Invoicee Party
    ...
    // Read information about the Payee Party
    ...
    // Read information about Payment Means
    ...
    // Read information about the Creditor Reference
    ...
    // Read information about the Payment Terms
    ...
    // Read information about the invoice taxes
    ...
    // Read information about the invoice alloances/charges
    ...
    // Read information about invoice total amounts
    ...
    while ($reader->nextDocumentPosition()) {
        ...
        $reader->getDocumentPositionQuantities(
            ...
            $positionPerPackageUnitQuantity,
            $positionPerPackageUnitQuantityUnit
        );
        ...
        echo sprintf("    - Per Package Quantity ... %s %s\n", $positionPerPackageUnitQuantity, $positionPerPackageUnitQuantityUnit);
