...
final class XRechnungUBLCreditNoteProviderReaderTest extends TestCase
{
    /**
     * The reader
     *
    ...
    {
        static::$document = new InvoiceSuiteXRechnungUBLCreditNoteProviderReader(new InvoiceSuiteXRechnungUBLCreditNoteProvider());
        ...
        static::$document->deserializeFromContent(
            file_get_contents(
                InvoiceSuitePathUtils::combinePathWithFile(
                    ...
                    '02_technical_xml_ubl_creditnote.xml'
                )
            )
        );
    }
    ...
    public function testGetDocumentType(): void
    {
        ...
        $this->assertSame('384', $newDocumentType);
    }
