...
final class XRechnungUBLCreditNoteReaderTest extends TestCase
{
    /**
     * The reader
     *
    ...
    public function testCopyToBuilder(): void
    {
        ...
        $this->assertSame('xrechnungublcreditnote', $builder->getCurrentDocumentFormatProvider()->getUniqueId());
    }
}
