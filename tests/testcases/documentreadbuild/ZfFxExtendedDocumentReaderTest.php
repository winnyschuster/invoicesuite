...
final class ZfFxExtendedDocumentReaderTest extends TestCase
{
    ...
    public function testDocumentSalesAgent(): void
    {
        ...
        $this->assertSame('Sales Agent GmbH', $newName);

        // ID

        $this->assertTrue(static::$document->firstDocumentSalesAgentId());
        ...
        $this->assertTrue(static::$document->firstDocumentSalesAgentGlobalId());
        ...
        $this->assertTrue(static::$document->nextDocumentSalesAgentGlobalId());
        ...
        $this->assertTrue(static::$document->firstDocumentSalesAgentTaxRegistration());
        ...
        $this->assertTrue(static::$document->firstDocumentSalesAgentAddress());
        ...
        $this->assertTrue(static::$document->firstDocumentSalesAgentLegalOrganisation());

        static::$document->getDocumentSalesAgentLegalOrganisation($newType, $newId, $newName);

        $this->assertSame('8884', $newType);
        $this->assertSame('19283746555', $newId);
        $this->assertSame('Sales Agent AG', $newName);

        $this->assertFalse(static::$document->nextDocumentSalesAgentLegalOrganisation());

        // Contact

        $this->assertTrue(static::$document->firstDocumentSalesAgentContact());
        ...
        $this->assertSame('0815-4711-0', $newPhoneNumber);
        $this->assertSame('0815-4712-0', $newFaxNumber);
        $this->assertSame('horst.meier@salesagent.de', $newEmailAddress);

        $this->assertFalse(static::$document->nextDocumentSalesAgentContact());

        // Communication

        $this->assertTrue(static::$document->firstDocumentSalesAgentCommunication());

        static::$document->getDocumentSalesAgentCommunication($newType, $newUri);

        $this->assertSame('EM', $newType);
        $this->assertSame('info@salesagent.de', $newUri);
